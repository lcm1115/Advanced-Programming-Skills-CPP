...
template class Backtrack<SkyscraperConfig>;
const SkyscraperConfig SkyscraperConfig::FAIL(true);
template class Backtrack<HitoriConfig>;
const HitoriConfig HitoriConfig::FAIL(true);
